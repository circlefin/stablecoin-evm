...
contract UpgradedFiatToken is FiatToken, UpgradedContract {
    ...
    constructor(address _contractStorageAddress, address _priorContractAddress, string _name, string _symbol, string _currency, uint8 _decimals, address _masterMinter, address _pauser, address _blacklister, address _upgrader, address _owner) public FiatToken(_contractStorageAddress, _name, _symbol, _currency, _decimals, _masterMinter, _pauser, _blacklister, _upgrader, _owner) {
