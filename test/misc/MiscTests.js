...
async function run_tests(newToken, accounts) {
  ...
  it("ms002 should transfer to self has correct final balance", async function () {
    ...
    await token.transfer(Accounts.arbitraryAccount, mintAmount, {
      from: Accounts.arbitraryAccount,
    });
  ...
  it("ms003 should transferFrom to self from approved account and have correct final balance", async function () {
    ...
    await token.approve(Accounts.arbitraryAccount2, mintAmount, {
      from: Accounts.arbitraryAccount,
    });
  ...
  it("ms004 should transferFrom to self from approved self and have correct final balance", async function () {
    ...
    await token.approve(Accounts.arbitraryAccount, mintAmount, {
      from: Accounts.arbitraryAccount,
    });
    await token.transferFrom(
      Accounts.arbitraryAccount,
  ...
  it("ms006 should approve correct allowance for self", async function () {
    ...
    await token.approve(Accounts.arbitraryAccount, amount, {
      from: Accounts.arbitraryAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms007 should configureMinter for masterMinter", async function () {
    await token.configureMinter(Accounts.masterMinterAccount, amount, {
      from: Accounts.masterMinterAccount,
    });
    var customVars = [
  ...
  it("ms009 should configure two minters", async function () {
    ...
    await token.configureMinter(Accounts.arbitraryAccount, amount, {
      from: Accounts.masterMinterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms010 should configure two minters and each mint distinct amounts", async function () {
    ...
    await token.mint(Accounts.arbitraryAccount2, mintAmount1, {
      from: Accounts.minterAccount,
    });
    await token.mint(Accounts.arbitraryAccount2, mintAmount2, {
      from: Accounts.arbitraryAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
      ...
      {
        variable: "minterAllowance.minterAccount",
        expectedValue: newBigNumber(amount - mintAmount1),
      },
      {
        variable: "minterAllowance.arbitraryAccount",
        expectedValue: newBigNumber(amount - mintAmount2),
      },
      {
        variable: "balances.arbitraryAccount2",
        expectedValue: newBigNumber(mintAmount1 + mintAmount2),
      },
      {
  ...
  it("ms011 should configure two minters, each minting distinct amounts and then remove one minter", async function () {
    ...
    await token.removeMinter(Accounts.arbitraryAccount, {
      from: Accounts.masterMinterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms012 should configure two minters and adjust both allowances", async function () {
    ...
    await token.configureMinter(Accounts.minterAccount, amount - adjustment, {
      from: Accounts.masterMinterAccount,
    });
    ...
    var customVars = [
      ...
      {
        variable: "minterAllowance.minterAccount",
        expectedValue: newBigNumber(amount - adjustment),
      },
      {
        variable: "minterAllowance.arbitraryAccount",
        expectedValue: newBigNumber(amount + adjustment),
  ...
  it("ms013 should configure two minters, one with zero allowance fails to mint", async function () {
    ...
    await token.configureMinter(Accounts.arbitraryAccount, 0, {
      from: Accounts.masterMinterAccount,
    });
    await token.mint(Accounts.arbitraryAccount2, mintAmount, {
      from: Accounts.minterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
    ...
    await expectRevert(
      token.mint(Accounts.arbitraryAccount2, mintAmount, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("ms014 should configure two minters and fail to mint when paused", async function () {
    ...
    await expectRevert(
      token.mint(Accounts.pauserAccount, mintAmount, {
        from: Accounts.minterAccount,
      })
    );
    await expectRevert(
  ...
  it("ms015 should configure two minters, blacklist one and ensure it cannot mint, then unblacklist and ensure it can mint", async function () {
    ...
    await token.blacklist(Accounts.minterAccount, {
    ...
    await token.unBlacklist(Accounts.minterAccount, {
      from: Accounts.blacklisterAccount,
    });
    await token.mint(Accounts.arbitraryAccount2, mintAmount, {
      from: Accounts.minterAccount,
    ...
    var customVars = [
      ...
      {
        variable: "totalSupply",
        expectedValue: newBigNumber(mintAmount + mintAmount),
      },
      {
        variable: "balances.arbitraryAccount2",
        expectedValue: newBigNumber(mintAmount + mintAmount),
  ...
  it("ms016 should configure two minters, each mints to themselves and then burns certain amount", async function () {
    ...
    await token.mint(Accounts.minterAccount, mintAmount1, {
      from: Accounts.minterAccount,
    });
    await token.mint(Accounts.arbitraryAccount, mintAmount2, {
      from: Accounts.arbitraryAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
      ...
      {
        variable: "balances.minterAccount",
        expectedValue: newBigNumber(mintAmount1),
      },
      {
        variable: "balances.arbitraryAccount",
        expectedValue: newBigNumber(mintAmount2),
      },
      {
        variable: "totalSupply",
        expectedValue: newBigNumber(mintAmount1 + mintAmount2),
    ...
    var customVars = [
      ...
      {
        variable: "balances.minterAccount",
        expectedValue: newBigNumber(mintAmount1 - burnAmount),
      },
      {
        variable: "balances.arbitraryAccount",
        expectedValue: newBigNumber(mintAmount2 - burnAmount),
      },
      {
        variable: "totalSupply",
        expectedValue: newBigNumber(
  ...
  it("ms018 should approve 0 token allowance with unchanged state", async function () {
    await token.approve(Accounts.minterAccount, 0, {
      from: Accounts.arbitraryAccount,
    });
  ...
  it("ms020 should transfer 0 tokens with unchanged state", async function () {
    await token.transfer(Accounts.arbitraryAccount, 0, {
      from: Accounts.arbitraryAccount2,
    });
    await checkVariables([token], [[]]);
  });
  ...
  it("ms039 should return true on mint", async function () {
    ...
    assert(
      await token.mint.call(Accounts.arbitraryAccount, mintAmount, {
        from: Accounts.minterAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("ms040 should return true on approve", async function () {
    assert(
      await token.approve.call(Accounts.minterAccount, amount, {
        from: Accounts.arbitraryAccount,
      })
    );
  });
  ...
  it("ms042 should return true on transfer", async function () {
    ...
    assert(
      await token.transfer.call(Accounts.pauserAccount, mintAmount, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("ms043 should return true on configureMinter", async function () {
    assert(
      await token.configureMinter.call(Accounts.minterAccount, amount, {
        from: Accounts.masterMinterAccount,
      })
    );
  });
  ...
  it("ms044 should return true on removeMinter", async function () {
    assert(
      await token.removeMinter.call(Accounts.minterAccount, {
        from: Accounts.masterMinterAccount,
      })
    );
  });
  ...
  it("ms047 configureMinter works on amount=2^256-1", async function () {
    await token.configureMinter(Accounts.minterAccount, maxAmount, {
      from: Accounts.masterMinterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms048 mint works on amount=2^256-1", async function () {
    ...
    await token.mint(Accounts.arbitraryAccount, maxAmount, {
      from: Accounts.minterAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms049 burn on works on amount=2^256-1", async function () {
    ...
    await token.mint(Accounts.minterAccount, maxAmount, {
      from: Accounts.minterAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("ms050 approve works on amount=2^256-1", async function () {
    ...
    await token.approve(Accounts.arbitraryAccount2, maxAmount, {
      from: Accounts.arbitraryAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
      ...
      { variable: "totalSupply", expectedValue: newBigNumber(maxAmount) },
      {
        variable: "allowance.arbitraryAccount.arbitraryAccount2",
        expectedValue: newBigNumber(maxAmount),
      },
    ];
    await checkVariables([token], [customVars]);
  ...
  it("ms051 transfer works on amount=2^256-1", async function () {
    ...
    await token.transfer(Accounts.arbitraryAccount2, maxAmount, {
      from: Accounts.arbitraryAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
