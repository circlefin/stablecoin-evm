...
deploy-verify:
	forge script scripts/deploy/deploy-fiat-token.s.sol -vv --gas-estimate-multiplier $(GAS_MULTIPLIER) --rpc-url $(RPC_URL) --etherscan-api-key $(ETHERSCAN_API_KEY) --verifier $(VERIFIER) --verify --verifier-url $(VERIFIER_URL) --broadcast --slow
