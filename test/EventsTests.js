...
async function run_tests(newToken, accounts) {
  ...
  it("et000 should check MinterConfigured event", async function () {
    let configureMinter = await token.configureMinter(minterAccount, amount, {
  ...
  it("et001 should check Mint/Transfer events", async function () {
    ...
    let mint = await token.mint(arbitraryAccount, amount, {
      from: minterAccount,
    });
  ...
  it("et003 should check MinterRemoved event", async function () {
    ...
    let minterRemovedEvent = await token.removeMinter(minterAccount, {
      from: masterMinterAccount,
    });
  ...
  it("et004 should check MasterMinterChanged event", async function () {
    let updateMasterMinter = await token.updateMasterMinter(arbitraryAccount, {
  ...
  it("et005 should check Blacklisted event", async function () {
    let blacklist = await token.blacklist(arbitraryAccount, {
  ...
  it("et006 should check UnBlacklisted event", async function () {
    let unblacklist = await token.unBlacklist(arbitraryAccount, {
      from: blacklisterAccount,
    });
  ...
  it("et007 should check BlacklisterChanged event", async function () {
    let blacklisterChanged = await token.updateBlacklister(arbitraryAccount, {
      from: tokenOwnerAccount,
    });
  ...
  it("et009 should check AdminChanged event", async function () {
    let adminChanged = await proxy.changeAdmin(arbitraryAccount, {
      from: proxyOwnerAccount,
    });
  ...
  it("et010 should check OwnershipTransferred event", async function () {
    let transferOwnership = await token.transferOwnership(arbitraryAccount, {
      from: tokenOwnerAccount,
    });
  ...
  it("et011 should check Approval event", async function () {
    let approval = await token.approve(arbitraryAccount2, amount, {
  ...
  it("et014 should check PauserChanged event", async function () {
    let updatePauser = await token.updatePauser(arbitraryAccount, {
      from: tokenOwnerAccount,
    });
  ...
  it("et015 should check Transfer event", async function () {
    ...
    let transfer = await token.transfer(arbitraryAccount2, amount, {
      from: arbitraryAccount,
    });
