...
contract("PausableTests", function (accounts) {
  ...
  it("constructor owner", async function () {
    ...
    assert.isTrue(
      addressEquals(Accounts.deployerAccount, actualOwner),
      "wrong owner"
    );
  });
  ...
  it("constructor pauser", async function () {
    ...
    assert.isTrue(
      addressEquals(Accounts.pauserAccount, actualOwner),
      "wrong pauser"
    );
  });
  ...
  it("update pauser", async function () {
    ...
    await pause.updatePauser(Accounts.arbitraryAccount, {
      from: Accounts.deployerAccount,
    });
  ...
  it("fail to update pauser from wrong account", async function () {
    await expectRevert(
      pause.updatePauser(Accounts.arbitraryAccount, {
