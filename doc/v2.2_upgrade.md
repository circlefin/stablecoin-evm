...
3. Look for the `deploy_v2_2`, `deploy_v2_2_upgrader`, and
   `deploy_erc1271_wallet` scripts in [`./migrations/`](../migrations/). Set the
   `MIGRATION_START` and `MIGRATION_END` variables based off the migration
   numbers of these scripts.
