...
import { AbstractFiatTokenV1Flattened } from "./AbstractFiatTokenV3.sol";
...
import { EIP3009V3 } from "./EIP3009V3.sol";
import { EIP2612V3 } from "./EIP2612V3.sol";
 ...
 */
contract FiatTokenV2Flattened is FiatTokenV1_1Flattened, EIP3009V3, EIP2612V3 {
 ...
 */
contract FiatTokenV3 is FiatTokenV2_1Flattened {
    /**
    ...
    function initializeV3(
        ...
        for (uint256 i = 0; i < accountsToBlacklist.length; i++) {
            require(
                ...
                "FiatTokenV3: Blacklisting previously unblacklisted account!"
            );
    ...
    function _setBalance(address _account, uint256 _balance) internal override {
        require(
            _balance <= ((1 << 255) - 1),
            "FiatTokenV3: Balance exceeds (2^255 - 1)"
        );
        require(
            !_isBlacklisted(_account),
            "FiatTokenV3: Account is blacklisted"
        );
