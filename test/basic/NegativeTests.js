...
async function run_tests(newToken, accounts) {
  ...
  it("nt001 should fail to mint when paused", async function () {
    ...
    await expectRevert(
      token.mint(Accounts.arbitraryAccount, 50, {
  ...
  it("nt005 should fail to mint when allowance of minter is less than amount", async function () {
    await token.configureMinter(Accounts.minterAccount, amount - 1, {
      from: Accounts.masterMinterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
      {
        variable: "minterAllowance.minterAccount",
        expectedValue: newBigNumber(amount - 1),
      },
    ];
    await expectRevert(
      token.mint(Accounts.arbitraryAccount, amount, {
        from: Accounts.minterAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("nt006 should fail to mint to 0x0 address", async function () {
    ...
    await expectRevert(
      token.mint(zeroAddress, amount, { from: Accounts.minterAccount })
    );
    await checkVariables([token], [customVars]);
  });
  ...
  it("nt008 should fail to approve when spender is blacklisted", async function () {
    ...
    await expectRevert(
      token.approve(Accounts.minterAccount, 100, {
  ...
  it("nt012 should fail to transferFrom to 0x0 address", async function () {
    ...
    await token.mint(Accounts.arbitraryAccount, 50, {
      from: Accounts.minterAccount,
    });
    await token.approve(Accounts.arbitraryAccount2, 50, {
      from: Accounts.arbitraryAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
      {
        variable: "minterAllowance.minterAccount",
        expectedValue: newBigNumber(amount - 50),
      },
      {
        variable: "balances.arbitraryAccount",
        expectedValue: newBigNumber(50),
      },
    ...
    await expectRevert(
      token.transferFrom(Accounts.arbitraryAccount, zeroAddress, 50, {
  ...
  it("nt013 should fail to transferFrom an amount greater than balance", async function () {
    ...
    await token.approve(Accounts.blacklisterAccount, amount, {
      from: Accounts.arbitraryAccount,
    });
    customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("nt014 should fail to transferFrom to blacklisted recipient", async function () {
    ...
    await token.mint(Accounts.blacklisterAccount, 50, {
      from: Accounts.minterAccount,
    });
    await token.approve(Accounts.arbitraryAccount2, 50, {
      from: Accounts.blacklisterAccount,
    ...
    customVars = [
      ...
      { variable: "totalSupply", expectedValue: newBigNumber(50) },
      {
        variable: "allowance.blacklisterAccount.arbitraryAccount2",
        expectedValue: newBigNumber(50),
      },
      {
        variable: "isAccountBlacklisted.arbitraryAccount",
  ...
  it("nt015 should fail to transferFrom from blacklisted msg.sender", async function () {
    ...
    await token.mint(Accounts.arbitraryAccount2, 50, {
      from: Accounts.minterAccount,
    });
    await token.approve(Accounts.arbitraryAccount, 50, {
      from: Accounts.arbitraryAccount2,
    });
    await token.blacklist(Accounts.arbitraryAccount, {
      from: Accounts.blacklisterAccount,
    ...
    customVars = [
      ...
      { variable: "totalSupply", expectedValue: newBigNumber(50) },
      {
        variable: "allowance.arbitraryAccount2.arbitraryAccount",
        expectedValue: newBigNumber(50),
      },
      {
        variable: "isAccountBlacklisted.arbitraryAccount",
  ...
  it("nt020 should fail to transfer to 0x0 address", async function () {
    ...
    await expectRevert(
      token.transfer(zeroAddress, 50, { from: Accounts.arbitraryAccount })
    );
    await checkVariables([token], [customVars]);
  });
  ...
  it("nt021 should fail to transfer an amount greater than balance", async function () {
    ...
    await expectRevert(
      token.transfer(Accounts.pauserAccount, amount, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("nt022 should fail to transfer to blacklisted recipient", async function () {
    ...
    await expectRevert(
      token.transfer(Accounts.arbitraryAccount, 50, {
        from: Accounts.arbitraryAccount2,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("nt023 should fail to transfer when sender is blacklisted", async function () {
    ...
    await expectRevert(
      token.transfer(Accounts.tokenOwnerAccount, 50, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("nt026 should fail to configureMinter when sender is not masterMinter", async function () {
    ...
    await expectRevert(
      token.configureMinter(Accounts.minterAccount, amount, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [[]]);
  ...
  it("nt029 should fail to removeMinter when sender is not masterMinter", async function () {
    ...
    await expectRevert(
      token.removeMinter(Accounts.minterAccount, {
        from: Accounts.arbitraryAccount,
      })
    );
    await checkVariables([token], [customVars]);
  ...
  it("nt032 should fail to burn when amount is -1", async function () {
    ...
    await token.mint(Accounts.minterAccount, amount, {
      from: Accounts.minterAccount,
    });
    var customVars = [
      { variable: "isAccountMinter.minterAccount", expectedValue: true },
  ...
  it("nt033 should fail to burn when sender is blacklisted", async function () {
    ...
    await token.mint(Accounts.minterAccount, 50, {
      from: Accounts.minterAccount,
    });
    await token.blacklist(Accounts.minterAccount, {
      from: Accounts.blacklisterAccount,
  ...
  it("nt050 should fail to updatePauser when sender is not owner", async function () {
    await expectRevert(
      token.updatePauser(Accounts.arbitraryAccount, {
        from: Accounts.pauserAccount,
      })
    );
    await checkVariables([token], [[]]);
  });
  ...
  it("nt049 should fail to updateMasterMinter when sender is not owner", async function () {
    await expectRevert(
      token.updateMasterMinter(Accounts.arbitraryAccount, {
        from: Accounts.pauserAccount,
      })
    );
    await checkVariables([token], [[]]);
  ...
  it("nt048 should fail to updateBlacklister when sender is not owner", async function () {
    await expectRevert(
      token.updateBlacklister(Accounts.arbitraryAccount, {
        from: Accounts.pauserAccount,
      })
    );
    await checkVariables([token], [[]]);
  ...
  it("nt043 should fail to unblacklist when sender is not blacklister", async function () {
    ...
    await expectRevert(
      token.unBlacklist(Accounts.arbitraryAccount, {
  ...
  it("nt054 should fail to transferOwnership when sender is not owner", async function () {
    ...
    await expectRevert(
      newToken.transferOwnership(Accounts.arbitraryAccount, {
        from: Accounts.arbitraryAccount2,
      })
    );
  ...
  it("nt055 should fail to mint when amount = 0", async function () {
    ...
    await expectRevert(
      token.mint(Accounts.pauserAccount, 0, { from: Accounts.minterAccount })
    );
  ...
  it("nt064 transferOwnership should fail on 0x0", async function () {
    await expectRevert(
      token.transferOwnership(zeroAddress, { from: Accounts.tokenOwnerAccount })
    );
  });

  it("nt057 updateMasterMinter should fail on 0x0", async function () {
    await expectRevert(
      token.updateMasterMinter(zeroAddress, {
        from: Accounts.tokenOwnerAccount,
      })
    );
  });
  ...
  it("nt058 updatePauser should fail on 0x0", async function () {
    await expectRevert(
      token.updatePauser(zeroAddress, { from: Accounts.tokenOwnerAccount })
    );
  });

  it("nt059 updateBlacklister should fail on 0x0", async function () {
    await expectRevert(
      token.updateBlacklister(zeroAddress, { from: Accounts.tokenOwnerAccount })
    );
  });
