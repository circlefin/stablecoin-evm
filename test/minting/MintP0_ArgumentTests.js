...
async function run_MINT_tests(newToken, MintControllerArtifact, accounts) {
    ...
    it('arg003 configureController(0, M) throws', async function () {
        await expectRevert(mintController.configureController(zeroAddress, Accounts.minterAccount, {from: Accounts.mintOwnerAccount}));
    });
    ...
    it('arg019 configureController(0, 0) throws', async function () {
        await expectRevert(mintController.configureController(zeroAddress, zeroAddress, {from: Accounts.mintOwnerAccount}));
    });
