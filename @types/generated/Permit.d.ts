...
export interface PermitContract extends Truffle.Contract<PermitInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<PermitInstance>;
}
...
export interface PermitInstance extends Truffle.ContractInstance {
