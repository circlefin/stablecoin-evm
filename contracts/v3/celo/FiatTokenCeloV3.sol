...
contract FiatTokenCeloV3 is FiatTokenV3, ICeloGasToken {
    ...
    modifier onlyFeeCaller() virtual {
        require(
            ...
            "FiatTokenCeloV3: caller is not the fee caller"
        );
        _;
    }
        ...
        notBlacklisted(communityFund)
    {
        ...
        require(
            ...
            "FiatTokenCeloV3: Either no debit or mismatched debit"
        );
    ...
    function _transferReservedGas(
        ...
        require(_value > 0, "FiatTokenCeloV3: Must reserve > 0 gas");
        require(
