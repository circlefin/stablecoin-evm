...
async function run_MINT_tests(newToken, MintControllerArtifact, accounts) {
    ...
    it('ete000 New owner can configure controllers', async function () {
        ...
        await mintController.configureController(Accounts.arbitraryAccount2, Accounts.minterAccount, {from: Accounts.arbitraryAccount});
        expectedMintControllerState.controllers['arbitraryAccount2'] = Accounts.minterAccount;
    ...
    it('ete001 New owner can remove controllers', async function () {
        await mintController.transferOwnership(Accounts.arbitraryAccount, {from: Accounts.mintOwnerAccount});
        await mintController.configureController(Accounts.arbitraryAccount2, Accounts.minterAccount, {from: Accounts.arbitraryAccount});
        await mintController.removeController(Accounts.arbitraryAccount2, {from: Accounts.arbitraryAccount});
        expectedMintControllerState.owner = Accounts.arbitraryAccount;
        await checkMINTp0([token, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete002 New controller can configure minter', async function () {
        ...
        await mintController.configureMinter(10, {from: Accounts.arbitraryAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedTokenState.push(
            { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
            { 'variable': 'minterAllowance.minterAccount', 'expectedValue': newBigNumber(10) }
        );
        await checkMINTp0([token, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete003 Configure two controllers for the same minter and make sure they can both configureMinter', async function () {
        await mintController.configureController(Accounts.arbitraryAccount, Accounts.minterAccount, {from: Accounts.mintOwnerAccount});
        await mintController.configureController(Accounts.arbitraryAccount2, Accounts.minterAccount, {from: Accounts.mintOwnerAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedMintControllerState.controllers['arbitraryAccount2'] = Accounts.minterAccount;
        ...
        await mintController.configureMinter(30, {from: Accounts.arbitraryAccount2});
        expectedTokenState.push(
            { 'variable': 'minterAllowance.minterAccount', 'expectedValue': newBigNumber(30) }
        );
        await checkMINTp0([token, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete005 Configure two controllers for different minters and make sure 2nd cant remove', async function () {
        await mintController.configureController(Accounts.arbitraryAccount, Accounts.minterAccount, {from: Accounts.mintOwnerAccount});
        await mintController.configureController(Accounts.arbitraryAccount2, Accounts.pauserAccount, {from: Accounts.mintOwnerAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedMintControllerState.controllers['arbitraryAccount2'] = Accounts.minterAccount;
    ...
    it('ete006 Configure two controllers for different minters and make sure 2nd cant configure', async function () {
        ...
        await mintController.configureMinter(20, {from: Accounts.arbitraryAccount2});
        expectedTokenState.push(
            { 'variable': 'isAccountMinter.pauserAccount', 'expectedValue': true },
            { 'variable': 'minterAllowance.pauserAccount', 'expectedValue': newBigNumber(20) }
        );
        await checkMINTp0([token, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete007 Remove a controller and make sure it can\'t modify minter', async function () {
        ...
        await expectError(mintController.configureMinter(10, {from: Accounts.arbitraryAccount}),
    ...
    it('ete008 Change minter manager and make sure existing controllers still can configure their minters', async function () {
        ...
        await newToken.updateMasterMinter(mintController.address, {from:Accounts.tokenOwnerAccount});
        ...
        await checkMINTp0([newToken, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete010 Change minter manager and make sure existing controllers can increment allowances', async function () {
        ...
        // now use controller to configure minter
        await mintController.configureMinter(10, {from: Accounts.arbitraryAccount});
        await mintController.incrementMinterAllowance(20, {from: Accounts.arbitraryAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedTokenState.push(
            { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
            { 'variable': 'minterAllowance.minterAccount', 'expectedValue': newBigNumber(30) }
    ...
    it('ete011 New controller can increment minter allowance', async function () {
        await mintController.configureController(Accounts.arbitraryAccount, Accounts.minterAccount, {from: Accounts.mintOwnerAccount});
        await mintController.configureMinter(0, {from: Accounts.arbitraryAccount});
        await mintController.incrementMinterAllowance(10, {from: Accounts.arbitraryAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedTokenState.push(
            { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
            { 'variable': 'minterAllowance.minterAccount', 'expectedValue': newBigNumber(10) }
    ...
    it('ete014 Remove a minter and then try to increment its allowance reverts', async function () {
        ...
        expectError(mintController.incrementMinterAllowance(20, {from: Accounts.arbitraryAccount}),
    ...
    it('ete015 Configure a minter and make sure it can mint', async function () {
        ...
        await token.mint(Accounts.arbitraryAccount, 5, {from: Accounts.minterAccount});
        expectedMintControllerState.controllers['arbitraryAccount'] = Accounts.minterAccount;
        expectedTokenState.push(
            { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
            { 'variable': 'minterAllowance.minterAccount', 'expectedValue': newBigNumber(5) },
    ...
    it('ete016 Remove a minter and make sure it cannot mint', async function () {
        ...
        expectRevert(token.mint(Accounts.arbitraryAccount2, 5, {from: Accounts.minterAccount}));
        await checkMINTp0([token, mintController], [expectedTokenState, expectedMintControllerState]);
    });
    ...
    it('ete017 Configure a minter and make sure it can burn', async function () {
        ...
        await token.mint(Accounts.minterAccount, 5, {from: Accounts.minterAccount});
...
testWrapper.execute('MINTp0_EndToEndTests MintController', run_tests_MintController);
testWrapper.execute('MINTp0_EndToEndTests MasterMinter', run_tests_MasterMinter);
